...
-- 2. Map a key to open LazyGit (instead of using setup)
-- ============================================================
do
  ...
  -- Paste over visual selection without losing current register contents
...
do
  ...
  require('blink.cmp').setup {
    ...
    -- the rust imlementation via `'prefer_rust_with_warning'`
    --
